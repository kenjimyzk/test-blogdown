...
screenreg(ll, stars = c(0.05, 0.01), custom.note = cn, override.se=selist,override.pvalues=pvlist)
```

係数の順序を変更
```{r}
screenreg(ll,  reorder.coef = c(2, 3, 4, 5, 1),
...
screenreg(ll, custom.model.names =cnm,
